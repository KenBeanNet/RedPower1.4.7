...
public class RedPowerWorld
{
    ...
    public void setupTools()
    {
        ...
        itemPickaxeRuby.setItemName("pickaxeRuby");
        ...
        itemPickaxeGreenSapphire.setItemName("pickaxeGreenSapphire");
        ...
        itemPickaxeSapphire.setItemName("pickaxeSapphire");
        ...
        itemShovelRuby.setItemName("shovelRuby");
        ...
        itemShovelGreenSapphire.setItemName("shovelGreenSapphire");
        ...
        itemShovelSapphire.setItemName("shovelSapphire");
        ...
        itemAxeRuby.setItemName("axeRuby");
        ...
        itemAxeGreenSapphire.setItemName("axeGreenSapphire");
        ...
        itemAxeSapphire.setItemName("axeSapphire");
        ...
        itemSwordRuby.setItemName("swordRuby");
        ...
        itemSwordGreenSapphire.setItemName("swordGreenSapphire");
        ...
        itemHoeRuby.setItemName("hoeRuby");
        ...
        itemHoeGreenSapphire.setItemName("hoeGreenSapphire");
        ...
        itemHoeSapphire.setItemName("hoeSapphire");
        ...
        itemSickleWood.setItemName("sickleWood");
        ...
        itemSickleStone.setItemName("sickleStone");
        ...
        itemSickleIron.setItemName("sickleIron");
        ...
        itemSickleDiamond.setItemName("sickleDiamond");
        ...
        itemSickleGreenSapphire.setItemName("sickleGreenSapphire");
        ...
        itemSickleSapphire.setItemName("sickleSapphire");
        ...
        itemHandsawRuby.setItemName("handsawRuby").setIconIndex(19);
        itemHandsawGreenSapphire.setItemName("handsawGreenSapphire").setIconIndex(20);
        itemHandsawSapphire.setItemName("handsawSapphire").setIconIndex(21);
        ...
        itemWoolCard.setItemName("woolcard").setIconIndex(28);
        ...
        itemBrushDry.setItemName("paintbrush.dry");
        ...
        itemPaintCanEmpty.setItemName("paintcan.empty");
        ...
        for (int var1 = 0; var1 < 16; ++var1)
        {
            ...
            itemPaintCanPaint[var1].setItemName("paintcan." + CoreLib.rawColorNames[var1]);
            ...
            itemBrushPaint[var1].setItemName("paintbrush." + CoreLib.rawColorNames[var1]);
