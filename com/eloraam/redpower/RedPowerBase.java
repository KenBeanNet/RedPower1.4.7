...
public class RedPowerBase
{
    ...
    public static void initBaseItems()
    {
        ...
        itemDrawplateDiamond.setItemName("drawplateDiamond").setIconIndex(27).setMaxDamage(255);
    ...
    public static void initIndigo()
    {
        ...
        itemPlanBlank.setItemName("planBlank");
    ...
    public static void initAlloys()
    {
        ...
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 6), new Object[] {new ItemStack(Item.doorSteel, 1)});
        ...
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 2), new Object[] {new ItemStack(Item.swordSteel, 1)});
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 3), new Object[] {new ItemStack(Item.pickaxeSteel, 1)});
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 3), new Object[] {new ItemStack(Item.axeSteel, 1)});
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 1), new Object[] {new ItemStack(Item.shovelSteel, 1)});
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 2), new Object[] {new ItemStack(Item.hoeSteel, 1)});
        ...
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 5), new Object[] {new ItemStack(Item.helmetSteel, 1)});
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 8), new Object[] {new ItemStack(Item.plateSteel, 1)});
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 7), new Object[] {new ItemStack(Item.legsSteel, 1)});
        CraftLib.addAlloyResult(new ItemStack(Item.ingotIron, 4), new Object[] {new ItemStack(Item.bootsSteel, 1)});
    ...
    public static void initCoverMaterials()
    {
        ...
        CoverLib.addMaterial(17, 1, Block.blockSteel, "iron", "Iron");
    ...
    public static void initBlocks()
    {
        ...
        itemHandsawIron.setItemName("handsawIron").setIconIndex(17);
        itemHandsawIron.setMaxDamage(320);
        itemHandsawDiamond.setItemName("handsawDiamond").setIconIndex(18);
        ...
        itemScrewdriver.setItemName("screwdriver").setIconIndex(16);
