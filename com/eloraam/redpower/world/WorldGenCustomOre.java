...
public class WorldGenCustomOre extends WorldGenerator
{
    ...
    public WorldGenCustomOre(int var1, int var2, int var3)
    {
    ...
    public void tryGenerateBlock(World var1, Random var2, int var3, int var4, int var5)
    {
        if (var1.getBlockId(var3, var4, var5) == Block.stone.blockID)
        {
            var1.setBlockAndMetadata(var3, var4, var5, this.minableBlockId, this.minableBlockMeta);
        }
    }
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                {
                                    this.tryGenerateBlock(var1, var2, var38, var41, var44);
                                }
                            }
                        }
                    }
