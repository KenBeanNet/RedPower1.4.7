            ...
            for (boolean var13 = false; var12.again(); var12.step())
            {
                ...
                else
                {
                    ...
                    if (var15 != null && var15.canSustainPlant(var3, var12.point.x, var12.point.y, var12.point.z, ForgeDirection.UP, var17))
                    {
                        ...
                        {
                            var13 = true;
                            var3.setBlockAndMetadata(var12.point.x, var12.point.y + 1, var12.point.z, var17.getPlantID(var3, var12.point.x, var12.point.y + 1, var12.point.z), var17.getPlantMetadata(var3, var12.point.x, var12.point.y + 1, var12.point.z));
