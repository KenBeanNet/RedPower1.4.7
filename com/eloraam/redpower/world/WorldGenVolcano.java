    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        ...
        else
        {
            ...
            for (var6 = var4; var6 < var7; ++var6)
            {
                ...
                var1.setBlockAndMetadata(var3 - 1, var6, var5, this.minableBlockId, this.minableBlockMeta);
                var1.setBlockAndMetadata(var3 + 1, var6, var5, this.minableBlockId, this.minableBlockMeta);
                var1.setBlockAndMetadata(var3, var6, var5 - 1, this.minableBlockId, this.minableBlockMeta);
                var1.setBlockAndMetadata(var3, var6, var5 + 1, this.minableBlockId, this.minableBlockMeta);
            }
                ...
                if (var1.blockExists(var12[0].intValue(), 64, var12[2].intValue()))
                {
                    ...
                    if (var14 <= var12[1].intValue())
                    {
                        ...
                        if (this.canReplaceId(var15))
                        {
                            ...
                            var1.setBlockAndMetadata(var12[0].intValue(), var14, var12[2].intValue(), this.minableBlockId, this.minableBlockMeta);
