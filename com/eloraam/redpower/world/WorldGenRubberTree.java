...
public class WorldGenRubberTree extends WorldGenerator
{
    public void putLeaves(World var1, int var2, int var3, int var4)
    {
        ...
        if (var5 == 0)
        {
            var1.setBlockAndMetadata(var2, var3, var4, RedPowerWorld.blockLeaves.blockID, 0);
        }
    }
    ...
    public boolean fillBlock(World var1, int var2, int var3, int var4)
    {
        if (var3 >= 0 && var3 <= 126)
        {
            ...
            {
                var1.setBlockAndMetadata(var2, var3, var4, RedPowerWorld.blockLogs.blockID, 0);
        ...
        if (var4 >= 1 && var4 + var9 + 2 <= var1.getHeight())
        {
            ...
            for (var11 = 0; var11 <= 6; ++var11)
            {
                for (var7 = -1; var7 <= 1; ++var7)
                {
                    for (var8 = -1; var8 <= 1; ++var8)
                    {
                        var1.setBlockAndMetadataWithNotify(var3 + var7, var4 + var11, var5 + var8, RedPowerWorld.blockLogs.blockID, 1);
                    }
                }
                ...
                for (var7 = -1; var7 <= 1; ++var7)
                {
                    ...
                    {
                        var1.setBlockAndMetadataWithNotify(var3 + var7, var4 + var11, var5 - 2, Block.vine.blockID, 1);
                    }

                    if (var2.nextInt(5) == 1 && var1.getBlockId(var3 + var7, var4 + var11, var5 + 2) == 0)
                    {
                        var1.setBlockAndMetadataWithNotify(var3 + var7, var4 + var11, var5 + 2, Block.vine.blockID, 4);
                    }
                }
                ...
                for (var8 = -1; var8 <= 1; ++var8)
                {
                    ...
                    {
                        var1.setBlockAndMetadataWithNotify(var3 - 2, var4 + var11, var5 + var8, Block.vine.blockID, 8);
                    }

                    if (var2.nextInt(5) == 1 && var1.getBlockId(var3 + 2, var4 + var11, var5 + var8) == 0)
                    {
                        var1.setBlockAndMetadataWithNotify(var3 + 2, var4 + var11, var5 + var8, Block.vine.blockID, 2);
                    }
                }
            }
