...
import com.eloraam.redpower.machine.TileBlueAlloyFurnace$1;
...
{
    BluePowerEndpoint cond = new TileBlueAlloyFurnace$1(this);
    ...
    boolean canSmelt()
    {
        ...
        else if (!this.contents[9].isItemEqual(var1))
        {
            return false;
        }
        else
        {
            int var2 = this.contents[9].stackSize + var1.stackSize;
    ...
    void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            {
                this.contents[9] = var1.copy();
            }
            else
            {
                this.contents[9].stackSize += var1.stackSize;
            }
        }
    }
    ...
    public boolean onBlockActivated(EntityPlayer var1)
    {
        ...
        {
            var1.openGui(RedPowerMachine.instance, 10, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            return true;
        }
    }
    ...
    public int getStartInventorySide(ForgeDirection var1)
    {
        ...
        return var2 == 1 ? 0 : (var2 == (var3 ^ 1) ? 9 : 0);
    }
    ...
    public int getSizeInventorySide(ForgeDirection var1)
    {
        int var2 = var1.ordinal();
        int var3 = CoreLib.rotToSide(this.Rotation);
        return var2 == 1 ? 9 : (var2 == (var3 ^ 1) ? 1 : 0);
    }
