        ...
        if (this.tempHot >= 100 && this.tempCold >= 200)
        {
            for (var3 = 0; var3 < 6; ++var3)
            {
                ...
                if ((var5 == Block.lavaMoving.blockID || var5 == Block.lavaStill.blockID) && this.worldObj.rand.nextInt(300) == 0)
                {
                    ...
                    this.worldObj.setBlockAndMetadataWithNotify(var4.x, var4.y, var4.z, var6 == 0 ? Block.obsidian.blockID : RedPowerWorld.blockStone.blockID, var6 > 0 ? 1 : 0);
                    break;
                }
            }
        }
        ...
        if (this.tempHot >= 100)
        {
            for (var3 = 0; var3 < 6; ++var3)
            {
                if (this.worldObj.rand.nextInt(300) == 0)
                {
                    ...
                    {
                        this.worldObj.setBlockWithNotify(var4.x, var4.y, var4.z, 0);
                        break;
                    }

                    if (var5 == Block.ice.blockID || var5 == Block.blockSnow.blockID)
                    {
                        this.worldObj.setBlockWithNotify(var4.x, var4.y, var4.z, this.worldObj.provider.isHellWorld ? 0 : Block.waterMoving.blockID);
                        break;
                    }
                }
            }
