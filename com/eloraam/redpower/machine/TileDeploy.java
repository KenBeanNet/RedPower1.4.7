...
public class TileDeploy extends TileDeployBase implements IInventory, ISidedInventory
{
    ...
    public boolean onBlockActivated(EntityPlayer var1)
    {
        ...
        {
            var1.openGui(RedPowerMachine.instance, 1, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            return true;
        }
    }
    ...
    protected void packInv(ItemStack[] var1)
    {
        for (int var2 = 0; var2 < 9; ++var2)
        {
            var1[var2] = fakePlayer.inventory.getStackInSlot(var2);
            fakePlayer.inventory.setInventorySlotContents(var2, this.contents[var2]);
        }
    }

    protected void unpackInv(ItemStack[] var1)
    {
        for (int var2 = 0; var2 < 9; ++var2)
        {
            this.contents[var2] = fakePlayer.inventory.getStackInSlot(var2);
            fakePlayer.inventory.setInventorySlotContents(var2, var1[var2]);
        }
    }
    ...
    public void enableTowards(WorldCoord var1)
    {
        ...
        {
            ItemStack var4 = this.contents[var3];

            if (var4 != null && var4.stackSize > 0 && this.tryUseItemStack(var4, var1.x, var1.y, var1.z, var3))
            {
                ...
                if (this.contents[var3].stackSize == 0)
                {
                    this.contents[var3] = null;
                }
    ...
    public int getStartInventorySide(ForgeDirection var1)
    {
        ...
        return (var2 ^ 1) == this.Rotation ? 0 : 0;
    }

    public int getSizeInventorySide(ForgeDirection var1)
    {
        int var2 = var1.ordinal();
        return (var2 ^ 1) == this.Rotation ? 0 : 9;
    }
