        ...
        if (var2.solveLimit(RedPowerMachine.FrameLinkSize))
        {
            if (var2.addMoved())
            {
                ...
                while (var3.hasNext())
                {
                    ...
                    this.worldObj.setBlockAndMetadataWithUpdate(var4.x, var4.y, var4.z, RedPowerMachine.blockFrame.blockID, 1, false);
            ...
            while (var4.hasNext())
            {
                ...
                if (var6 != null)
                {
                    ...
                    if (var6.movingBlockID != 0)
                    {
                        boolean var8 = this.worldObj.isRemote;
                        this.worldObj.isRemote = true;
                        this.worldObj.setBlockAndMetadataWithUpdate(var7.x, var7.y, var7.z, var6.movingBlockID, var6.movingBlockMeta, false);
                        this.worldObj.isRemote = var8;
