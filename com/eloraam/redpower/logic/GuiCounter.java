...
public class GuiCounter extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        this.controlList.add(this.buttons[0] = new GuiButton(1, var2 + 10, var3 + 20, var1 / 6, 20, "-25"));
        this.controlList.add(this.buttons[1] = new GuiButton(2, var2 + 10 + var1 / 6, var3 + 20, var1 / 6, 20, "-5"));
        this.controlList.add(this.buttons[2] = new GuiButton(3, var2 + 10 + var1 * 2 / 6, var3 + 20, var1 / 6, 20, "-1"));
        this.controlList.add(this.buttons[3] = new GuiButton(4, var2 + 10 + var1 * 3 / 6, var3 + 20, var1 / 6, 20, "+1"));
        this.controlList.add(this.buttons[4] = new GuiButton(5, var2 + 10 + var1 * 4 / 6, var3 + 20, var1 / 6, 20, "+5"));
        this.controlList.add(this.buttons[5] = new GuiButton(6, var2 + 10 + var1 * 5 / 6, var3 + 20, var1 / 6, 20, "+25"));
        this.controlList.add(this.buttons[6] = new GuiButton(7, var2 + 10, var3 + 55, var1 / 6, 20, "-25"));
        this.controlList.add(this.buttons[7] = new GuiButton(8, var2 + 10 + var1 / 6, var3 + 55, var1 / 6, 20, "-5"));
        this.controlList.add(this.buttons[8] = new GuiButton(9, var2 + 10 + var1 * 2 / 6, var3 + 55, var1 / 6, 20, "-1"));
        this.controlList.add(this.buttons[9] = new GuiButton(10, var2 + 10 + var1 * 3 / 6, var3 + 55, var1 / 6, 20, "+1"));
        this.controlList.add(this.buttons[10] = new GuiButton(11, var2 + 10 + var1 * 4 / 6, var3 + 55, var1 / 6, 20, "+5"));
        this.controlList.add(this.buttons[11] = new GuiButton(12, var2 + 10 + var1 * 5 / 6, var3 + 55, var1 / 6, 20, "+25"));
        this.controlList.add(this.buttons[12] = new GuiButton(13, var2 + 10, var3 + 90, var1 / 6, 20, "-25"));
        this.controlList.add(this.buttons[13] = new GuiButton(14, var2 + 10 + var1 / 6, var3 + 90, var1 / 6, 20, "-5"));
        this.controlList.add(this.buttons[14] = new GuiButton(15, var2 + 10 + var1 * 2 / 6, var3 + 90, var1 / 6, 20, "-1"));
        this.controlList.add(this.buttons[15] = new GuiButton(16, var2 + 10 + var1 * 3 / 6, var3 + 90, var1 / 6, 20, "+1"));
        this.controlList.add(this.buttons[16] = new GuiButton(17, var2 + 10 + var1 * 4 / 6, var3 + 90, var1 / 6, 20, "+5"));
        this.controlList.add(this.buttons[17] = new GuiButton(18, var2 + 10 + var1 * 5 / 6, var3 + 90, var1 / 6, 20, "+25"));
    }
