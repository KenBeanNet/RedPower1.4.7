...
public class GuiTimer extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        this.controlList.add(this.buttons[0] = new GuiButton(1, var2 + 10, var3 + 50, var1 / 6, 20, "-10s"));
        this.controlList.add(this.buttons[1] = new GuiButton(2, var2 + 10 + var1 / 6, var3 + 50, var1 / 6, 20, "-1s"));
        this.controlList.add(this.buttons[2] = new GuiButton(3, var2 + 10 + var1 * 2 / 6, var3 + 50, var1 / 6, 20, "-50ms"));
        this.controlList.add(this.buttons[3] = new GuiButton(4, var2 + 10 + var1 * 3 / 6, var3 + 50, var1 / 6, 20, "+50ms"));
        this.controlList.add(this.buttons[4] = new GuiButton(5, var2 + 10 + var1 * 4 / 6, var3 + 50, var1 / 6, 20, "+1s"));
        this.controlList.add(this.buttons[5] = new GuiButton(6, var2 + 10 + var1 * 5 / 6, var3 + 50, var1 / 6, 20, "+10s"));
    }
