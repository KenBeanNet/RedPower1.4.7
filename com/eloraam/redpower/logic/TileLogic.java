...
public class TileLogic extends TileCoverable implements IHandlePackets, IRedPowerConnectable, IRotatable, IFrameSupport
{
    ...
    public float getPartStrength(EntityPlayer var1, int var2)
    {
        ...
        return var2 == this.Rotation >> 2 ? var1.getCurrentPlayerStrVsBlock(var3, 0) / (var3.getHardness() * 30.0F) : super.getPartStrength(var1, var2);
    }
    ...
    {
        return (this.getPoweringMask(0) & RedPowerLib.getConDirMask(var1 ^ 1)) > 0;
    }
