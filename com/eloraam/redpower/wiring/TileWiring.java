...
public abstract class TileWiring extends TileCovered implements IWiring
{
    ...
    public float getPartStrength(EntityPlayer var1, int var2)
    {
        ...
        return var2 == 29 && (this.ConSides & 64) > 0 ? var1.getCurrentPlayerStrVsBlock(var3, 0) / (var3.getHardness() * 30.0F) : ((this.ConSides & 1 << var2) > 0 ? var1.getCurrentPlayerStrVsBlock(var3, 0) / (var3.getHardness() * 30.0F) : super.getPartStrength(var1, var2));
    }
