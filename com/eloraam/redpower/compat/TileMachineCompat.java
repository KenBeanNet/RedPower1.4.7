...
public class TileMachineCompat extends TileMultipart implements IHandlePackets, IRotatable, IFrameSupport
{
    ...
    {
        return RedPowerCompat.blockMachineCompat.blockID;
    }
    ...
    {
        BlockMachineCompat var3 = RedPowerCompat.blockMachineCompat;
        return var1.getCurrentPlayerStrVsBlock(var3, 0) / (var3.getHardness() * 30.0F);
    }
