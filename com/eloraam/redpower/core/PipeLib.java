...
public class PipeLib
{
    ...
    public static void registerVanillaFluid(int var0, int var1)
    {
        ...
        if (var2 != null)
        {
            FluidClassVanilla var3 = new FluidClassVanilla(var0, var0, var1, var2.getTextureFile(), var2.getBlockTextureFromSide(0));
    ...
    public static void registerForgeFluid(String var0, LiquidStack var1)
    {
        ...
        if (var2 != null)
        {
            ...
            FluidClassItem var4 = new FluidClassItem(var3, var1.itemID, var1.itemMeta, var2.getTextureFile(), CoreProxy.instance.getItemIcon(var2, var1.itemMeta));
